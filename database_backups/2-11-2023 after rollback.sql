...
(1, 'Dirk', 'Pearce', 25, 1),
(2, 'Linda', 'Ricker', 25, 2),
(3, 'Derwin', 'Loverink', 27, 13),
(4, 'Jackie', 'Berry', 27, 14),
(5, 'Mitch ', 'Domer', 4, 4),
(6, 'Lisa', 'Domer', 28, 15),
(7, 'Kelly', 'Utlak', 25, 5);
...
INSERT INTO `tbl_titles` (`title_id`, `title_name`) VALUES
(1, 'Superintendant'),
(2, 'Principal'),
...
ALTER TABLE `tbl_employees`
  ...
  ADD KEY `employee_title_id` (`employee_title_id`);
...
--
ALTER TABLE `tbl_employees`
  ADD CONSTRAINT `tbl_employees_ibfk_1` FOREIGN KEY (`employee_dept_id`) REFERENCES `tbl_departments` (`department_id`),
  ADD CONSTRAINT `tbl_employees_ibfk_2` FOREIGN KEY (`employee_title_id`) REFERENCES `tbl_titles` (`title_id`);
